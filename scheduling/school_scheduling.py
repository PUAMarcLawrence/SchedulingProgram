...
def main_program():
    ...
    menu_option = st.sidebar.selectbox(
        "Choose an option", 
        ["Add Class", "Show Schedule", "Export Schedule to Excel", "Delete Class", "Edit Class"]
    )
    ...
    match menu_option:
        case "Add Class":
            ...
            class_name = st.text_input(
                "Class Name", 
                placeholder="Enter the class name (e.g., Mathematics)"
            )
            section = st.text_input(
                "Section", 
                placeholder="Enter the section (e.g., E01)"
            )
            ...
            if curriculum == "Add New Curriculum":
                curriculum = st.text_input(
                    ...
                    placeholder="Enter the new curriculum name (e.g., COE)"
                )
