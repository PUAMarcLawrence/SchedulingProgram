...
# import time
# from utils.db_utils import change_password_to_new
...
#                     change_password_result = change_password_to_new(st.session_state['username'], old_password, new_password)
#                     if change_password_result.get("status"):
#                         st.success(change_password_result.get("message"))
#                         time.sleep(2)
#                         st.rerun()
#                     else:
#                         st.error(change_password_result.get("message"))
#             else:
...
# --- Helper to avoid repetitive markdown + image code ---
def render_manual_step(texts, images=None, html=False):
    """Render one or more steps with optional images."""
...
def change_password_form():
    ...
    if st.button("Change Password"):
        ...
        with st.spinner("Updating password..."):
            result = change_password_to_new(st.session_state['username'], old_password, new_password)
...
# --- User Manual Section (all original text preserved) ---
def userManual():
    # with st.expander("USER MANUAL"):
        st.markdown("<h1 style= 'text-align: center;'>USER MANUAL</h1>", unsafe_allow_html=True)
        st.markdown("<p style= 'text-align: center;'>This is the user manual on how to use the Scheduling Tools program</p>", unsafe_allow_html=True)
        ...
        render_manual_step(
            ...
            "images/usermanual_images/Picture1.png"
        )
        ...
        render_manual_step(
            ...
            "images/usermanual_images/Picture2.png"
        )
        ...
        ], "images/usermanual_images/Picture3.png")
        ...
        ], "images/usermanual_images/Picture4.png")
        ...
        render_manual_step(
            ...
            "images/usermanual_images/Picture5.png"
        )
        ...
        render_manual_step(
            ...
            "images/usermanual_images/Picture6.png"
        )
        ...
        render_manual_step(
            ...
            <p>b.\tThe Settings button leads the user to the Settings page where the user can change his password</p>
            """,
            "images/usermanual_images/Picture7.png",
            html=True
        )
        ...
        render_manual_step(
            ...
            ["images/usermanual_images/Picture10.png", "images/usermanual_images/Picture11.png"]
        )
        ...
        render_manual_step(
            ...
            <p>e.\tThe Quick View Button asks the user to choose a program to display its curriculum</p>
            """,
            "images/usermanual_images/Picture12.png",
            html=True
        )

        render_manual_step(
            "When a curriculum is chosen, the curriculum’s program tree will be displayed. The Program Tree displays all courses in the curriculum connected by their pre-requisites or co-requisites.",
            "images/usermanual_images/Picture13.png"
        )
        ...
        render_manual_step(
            ...
            <p>The window of the Program Tree can be zoomed in for a more clearer readability and navigation</p>
            <p>The user can click and hover on any node to see the information of the course and the courses it is connected to</p>    
            """, "images/usermanual_images/Picture14.png", html=True
        )
        ...
        render_manual_step(
            ...
            "images/usermanual_images/Picture15.png"
        )

        render_manual_step(
            "After creating a sandbox, the user can select the sandbox from the dropdown menu",
            ["images/usermanual_images/Picture16.png", "images/usermanual_images/Picture17.png"]
        )
        ...
        render_manual_step(
            ...
            <p>After modifying, the user can press the save button to apply the changes.</p>
            <p>g.\tThe School Scheduling Button leads the user to a new page that allows him to create a schedule that is shared and can be seen by all users</p>
            """, ["images/usermanual_images/Picture18.png", "images/usermanual_images/Picture19.png"], html=True
        )

        render_manual_step(
            "The user can fill in all the blanks and choose all needed options to create a class he desires",
            ["images/usermanual_images/Picture20.png", "images/usermanual_images/Picture21.png"]
        )
        ...
        render_manual_step(
            ...
            <p>After filling all blanks and selecting needed options, the user can click on Add Class to create the class.</p>
            <p>The user then can click on the drop down menu on the side bar of the website and select show schedule to see the class he created.</p>
            """, ["images/usermanual_images/Picture22.png", "images/usermanual_images/Picture23.png"], html=True
        )

        render_manual_step(
            "h.\tOn the sidebar, the user can also export the schedules selected from specific Curriculums, Batch, and Terms",
            "images/usermanual_images/Picture24.png"
        )

        render_manual_step(
            "i.\tOn the sidebar, the user can select Delete classes to be able to remove classes",
            "images/usermanual_images/Picture25.png"
        )
        ...
        render_manual_step(
            ...
            <p>They can select a class from a curriculum, batch, and Term to delete</p>
            <p>j.\tLastly, the user can select the edit a class from the sidebar to be able to modify classes</p>
            """, "images/usermanual_images/Picture26.png", html=True
        )

# --- Main Page ---
option = st.sidebar.selectbox("Settings", ["Change Password", "User Manual"])
