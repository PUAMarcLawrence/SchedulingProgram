...
template_file_name = "template/Curriculum.xlsx"
...
if uploaded_file is not None:
    try:
        ...
        st.warning("Please make sure that you double check the data before uploading. If YEAR, TERM, COURSE CODE are NONE/Blank would NOT be recorded", icon="⚠️")
        st.write("Editable preview of Excel data:")
        Edited_data = st.data_editor(
            data,
            column_config={
                "Req_Year_Standing": st.column_config.NumberColumn("R.Y.S."),},
